$(document).ready(function() {
    ...
    function addItem(element) {
        ...
        var row = '<li class="list-group-item"><div class="pull-right"><a class="btn btn-default btn-sm" href="' + contestAdminUrl + '?id=' + element.id + '"><i class="glyphicon glyphicon-cog"></i></a></div><h4 class="list-group-item-heading">' + element.name + '</h4><p class="list-group-item-text">' + timeString + '</p></li>';
        $('#contests').append(row);
    }
